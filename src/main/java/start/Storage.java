...
//    ...
    ...
    public int costOfProject(long projectId) {
        try {
            ResultSet rs = statement.executeQuery("select sum(developers.salary) from developers\n" +
    ...
    public List<Project> listOfProjectsInfo() {
        ...
        ResultSet rs = null;
        try {
            rs = statement.executeQuery("select projects.project_name, count(developer_id) from projects\n" +
...
//        }
        ...
        System.out.println("----------");
        System.out.println(storage.costOfProject(2));
        System.out.println("----------");
        for (Developer dev : storage.listOfDevelopersOfProject(2)) {
            System.out.println(dev);
        }
        System.out.println("----------");
        for (Developer dev : storage.listOfJavaDevelopers()) {
            System.out.println(dev);
        }
        System.out.println("----------");
        for (Developer dev : storage.listOfMiddleDevelopers()) {
            System.out.println(dev);
        }
        System.out.println("----------");
        for (Project project : storage.listOfProjectsInfo()) {
